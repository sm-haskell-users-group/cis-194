...
hanoi4 size from to swap1 swap2
    | size > 3  = (hanoi4 (size - 1) from swap1 to swap2) ++ (hanoi4 1 from to swap1 swap2) ++ (hanoi4 (size - 1) swap1 to from swap2)
    | size == 3 = [(from, swap1), (from, swap2), (from, to), (swap2, to), (swap1, to)]
    | size < 3  = hanoi size from to swap1
